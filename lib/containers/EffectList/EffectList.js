...
var _EffectEntry = require('../EffectEntry');
...
var EffectListContainer = _styledComponents2.default.div(_templateObject);

var cssMatchAction = (0, _styledComponents.css)(_templateObject2);
...
var EffectList = function (_React$Component) {
  ...
  function EffectList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EffectList.__proto__ || Object.getPrototypeOf(EffectList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return _this.state.collapsedEffects[effectId] || false;
  ...
  _createClass(EffectList, [{
    ...
    value: function renderEffectList(effectIds, elems) {
      ...
      return effectIds.forEach(function (effectId, idx) {
        ...
        var effect = _this2.props.effectsById[effectId];
        var childsEffectsId = _this2.props.effectsByParentId[effectId];
        var hasChildren = childsEffectsId && childsEffectsId.length;
        var css = (0, _selectors.matchCurrentAction)(_this2.props.state, effectId) ? cssMatchAction : null;
...
EffectList.propTypes = {
  ...
  selectedEffectId: _propTypes2.default.number,
  ...
  effectsByParentId: _propTypes2.default.object.isRequired
};
